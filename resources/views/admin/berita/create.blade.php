...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0" style="color: #333; font-weight: 700;">Tambah <span style="color: #d4af37;">Berita</span></h1>
...
<div class="card shadow mb-4 bg-dark text-white" style="border: 1px solid #2a2a2a; border-radius: 10px;">
    <div class="card-header py-3 bg-dark" style="border-bottom: 1px solid #2a2a2a; border-radius: 10px 10px 0 0;">
        <h6 class="m-0 font-weight-bold" style="color: #d4af37;">Formulir Penerbitan Berita Baru</h6>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.berita.store') }}" method="POST">
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" class="form-control bg-dark text-white @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="Tuliskan judul berita yang menarik..." style="border: 1px solid #444; border-radius: 8px;">
                @error('name')
            ...
            <div class="form-group mb-4">
                ...
                <textarea class="form-control bg-dark text-white @error('description') is-invalid @enderror" id="description" name="description" rows="10" placeholder="Tulis konten berita lengkap di sini..." style="border: 1px solid #444; border-radius: 8px;">{{ old('description') }}</textarea>
                @error('description')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group mb-4">
                ...
                <div class="custom-control custom-switch">
                    ...
                    <label class="custom-control-label text-white-50" for="is_active">Langsung terbitkan berita ini ke publik</label>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end">
                ...
                <button type="submit" class="btn btn-primary" style="border-radius: 20px; font-weight: 600; padding: 8px 24px; background-color: #d4af37 !important; border-color: #d4af37 !important; color: #1a1a1a !important;">Terbitkan Berita</button>
            </div>
